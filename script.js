    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משרד עורך דין יעקב טוביה בן דוד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4d75f560-b2c0-48b8-9d33-12f544a778c2',
                    name: data.name || '',
                    email: data.email || '',
